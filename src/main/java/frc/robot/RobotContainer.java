...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    JoystickButton exampleButton = new JoystickButton(joystickOne, 7);
    exampleButton.whileTrue(new InstantCommand(() -> m_ExampleSubsystem.exampleMethodCommand()))
    .onFalse(new InstantCommand(() -> m_ExampleSubsystem.exampleMethodCommand()));
